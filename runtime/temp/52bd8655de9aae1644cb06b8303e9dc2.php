<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\www\demo\tp5\public/../application/admin\view\system\edit.html";i:1510219100;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo url('system/update'); ?>" id="myform" class="form-horizontal">
                            <input type="hidden" name="id" value="<?php echo $system->id; ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">配置名称</label>

                                <div class="col-sm-4">
                                    <input type="text" class="form-control" placeholder="请输入配置名称" name="name" value="<?php echo $system->name; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" placeholder="请输入配置值" name="value" value="<?php echo $system->value; ?>"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <textarea name="desc"  class="form-control" rows="6"  ><?php echo $system->desc; ?></textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
        ...
        $('#myform')
            ...
            .on('success.form.bv', function(e) {
                ...
                $.post($form.attr('action'), $form.serialize(), function(rs) {
                    ...
                    if(rs.status == 200){
                        setTimeout(function (){
                            window.location.href = "<?php echo url('systemPP/index'); ?>"
                        },1000);
                    }

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\www\demo\tp5\public/../application/admin\view\admin\index.html";i:1506650674;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped table-bordered table-hover " id="editable">
                            ...
                            <tbody>
                            <?php if(!(empty($admins) || (($admins instanceof \think\Collection || $admins instanceof \think\Paginator ) && $admins->isEmpty()))): if(is_array($admins) || $admins instanceof \think\Collection || $admins instanceof \think\Paginator): $i = 0; $__LIST__ = $admins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?>

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\www\demo\tp5\public/../application/admin\view\system\index.html";i:1510218401;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="col-sm-1">
                            <a  href="<?php echo url('system/create'); ?>" class="btn btn-primary ">添加</a>
                        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover " id="editable">
                            ...
                            <tbody>
                            <?php if(!(empty($systems) || (($systems instanceof \think\Collection || $systems instanceof \think\Paginator ) && $systems->isEmpty()))): if(is_array($systems) || $systems instanceof \think\Collection || $systems instanceof \think\Paginator): $i = 0; $__LIST__ = $systems;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$system): $mod = ($i % 2 );++$i;?>
                                <tr class="gradeX" id="rem<?php echo $system->id; ?>">
                                    <td><?php echo $system->id; ?></td>
                                    <td><?php echo $system->name; ?></td>
                                    <td><?php echo $system->value; ?></td>
                                    <td class="center"><?php echo $system->desc; ?></td>
									<td class="center">
										<?php echo $system->status; ?>
									</td>
                                    <td class="center">
										<a class="glyphicon glyphicon-pencil" title="编辑" href="<?php echo url('admin/system/edit',array('id'=>$system->id)); ?>"></a>
										<a class="glyphicon glyphicon-trash"  title="删除" onclick="del(<?php echo $system->id; ?>)"></a>

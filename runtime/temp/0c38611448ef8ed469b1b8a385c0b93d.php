<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\www\demo\tp5\public/../application/admin\view\category\edit.html";i:1510284509;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>分类列表 <small>/编辑分类</small></h5>
                       
                    </div>
                    <div class="ibox-content">
                        <form method="post" action="<?php echo url('category/update'); ?>" id="myform" class="form-horizontal">
                            <input type="hidden" name="id" value="<?php echo $category->id; ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">分类标识</label>

                                <div class="col-sm-4">
                                    <input type="text" class="form-control" placeholder="请输入唯一标识" name="name" value="<?php echo $category->name; ?>">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control m-b" name="pid">
                                        ...
                                        <?php if(is_array($categorys) || $categorys instanceof \think\Collection || $categorys instanceof \think\Paginator): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                         <option value="<?php echo $cate->id; ?>" <?php if($cate->id == $category->pid): ?> selected <?php endif; ?>><?php echo $cate->title; ?><?php echo $category->pid; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" placeholder="请输入分类标题" name="title" value="<?php echo $category->title; ?>"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" placeholder="请输入排序" name="sort" value="<?php echo $category->sort; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                   <input type="text" name="keywords" placeholder="请输入排序" class="form-control" value="<?php echo $category->keywords; ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
